$(document).ready(function () {
    ...
    function Field(row, col) {
        ...
        this.maxMoveLeftTop = 1;
        this.maxMoveRightTop = 1;
        this.maxMoveLeftBottom = 1;
        this.maxMoveRightBottom = 1;
        this.draw = function () {
            this.value = gameMap[row][col];
            if (isNextJump == false) {
            ...
            if (this.value == 1) {
                ...
                $("#field" + this.row + this.col).html("<svg xmlns=\"http://www.w3.org/2000/svg\"><circle cx=\"50\" cy=\"50\" r=\"40\" fill=\"#edf8ff\" /></svg><img src=\"crown.svg\" class=\"crown\">");
            } else if (this.value == 6) {
                $("#field" + this.row + this.col).html("<svg xmlns=\"http://www.w3.org/2000/svg\"><circle cx=\"50\" cy=\"50\" r=\"40\" fill=\"red\" /></svg>");
            } else if (this.value == 7) {
                $("#field" + this.row + this.col).html("<svg xmlns=\"http://www.w3.org/2000/svg\"><circle cx=\"50\" cy=\"50\" r=\"40\" fill=\"#d8111b\" /></svg><img src=\"crown.svg\" class=\"crown\">");
            }
    ...
    function chooseField(varField) {
        if (isNextJump == false) {
            if (chosenField == varField) {
